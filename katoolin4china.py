...
\033[1;33m[W] Before updating your system , please remove all Kali-linux repositories to avoid any kind of problem .\033[1;m
        ''')
...
0) All
             ...
             ''')
                        ...
                        if opcion1 == "back":
                            ...
                            for kt in kalitool:
                                    if not (os.system("apt-get -f install %s" % kt)):
